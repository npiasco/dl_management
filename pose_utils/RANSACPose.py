...
def ransac_pose_estimation(pt, pt_nn):
    ransac = sklearn.linear_model.RANSACRegressor(base_estimator=PoseEstimator(), min_samples=0.1, max_trials=100,  loss='squared_loss')#, residual_threshold=1e-3, loss='squared_loss')
