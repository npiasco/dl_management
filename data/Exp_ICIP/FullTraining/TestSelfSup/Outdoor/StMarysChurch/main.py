...
if __name__ == '__main__':
    ...
    if action == 't':
        ...
        machine.map_print(batch_size=1, aux_mod='rgb')
    elif action == 'mf':
        machine.map_print(final=True, batch_size=1, aux_mod='rgb')
    elif action == 'pose':
